...
export default ({ffmpeg}) =>{
    ...
    return(
        <div className="parent xl:border-gray-400 xl:shadow-lg xl:p-4 xl:rounded-lg flex flex-col gap-2">
            <div className="top flex flex-col gap-2 xl:gap-0 xl:flex-row xl:justify-between">
                <h2 className="font-bold text-2xl">Dashboard</h2>
                <input className="xl:text-right file:rounded file:border-0 xl:file:mr-2 file:bg-blue-500 file:text-white file:py-1 file:px-2"
            ...
            <div className='flex flex-col xl:flex-row'>
                ...
                <div className="body flex flex-col gap-2">
                    <div>
                        ...
                        <div className="flex gap-1">
                            <input className="border rounded text-center [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                ...
                <div className='p-2 flex flex-col justify-between gap-2'>
                    ...
                    <div className='flex flex-col gap-1'>
                        <p>Audio</p>
                        <audio className="rounded-md" ref={outaudioRef} controls></audio><br/>
                    ...
                    <div className="flex flex-col gap-1">
                        <p>Video</p>
                        <video ref={outputVidRef} className="rounded-md" controls width="300" height="300" ></video><br/>
